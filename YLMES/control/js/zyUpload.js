	...
	$.fn.zyUpload = function(options,param){
		...
		return this.each(function(){
			...
			var defaults = {
					width            : "1000px",  					// 宽度
					height           : "800px",  					// 宽度
					itemWidth        : "900px",                     // 文件项的宽度
					itemHeight       : "300px",                     // 文件项的高度
					url              : "~/upload",  	// 上传文件的路径
			...
			this.createHtml = function(){
				...
				var html= '';
				var url = '/TechnicalDepartmen/UploadDrawings'
				if(para.dragDrop){
					// 创建带有拖动的html
				    html += '<form id="uploadForm" action="' + url + '" method="post" enctype="multipart/form-data">';
				    html += ' <span style="font-size:20px;font-weight:bold;">图号:</span><input class="hao" id="hao" type="text" style="width: 280px;height:40px;border:1px solid blue;font-size:25px" /> ';
